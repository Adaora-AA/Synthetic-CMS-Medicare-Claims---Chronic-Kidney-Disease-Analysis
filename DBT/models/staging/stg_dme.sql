...
select
    ...
    {{ dbt.safe_cast('DMERC_LINE_PRCNG_STATE_CD', api.Column.translate_type("string")) }}                                                    as dmerc_line_prcng_state_cd,
    ...
    {{ dbt.safe_cast('HCPCS_3RD_MDFR_CD', api.Column.translate_type("string")) }}                                                            as hcpcs_3rd_mdfr_cd,
    {{ dbt.safe_cast('HCPCS_4TH_MDFR_CD', api.Column.translate_type("string")) }}                                                            as hcpcs_4th_mdfr_cd,
    ...
    {{ dbt.safe_cast('DMERC_LINE_SUPPLR_TYPE_CD', api.Column.translate_type("string")) }}                                                    as dmerc_line_supplr_type_cd,
    ...
    {{ dbt.safe_cast('DMERC_LINE_MTUS_CD', api.Column.translate_type("string")) }}                                                           as dmerc_line_mtus_cd,
    {{ dbt.safe_cast('PRVDR_NPI', api.Column.translate_type("string")) }}                                                                    as prvdr_npi,
    {{ dbt.safe_cast('TAX_NUM', api.Column.translate_type("string")) }}                                                                      as tax_num,
    {{ dbt.safe_cast('LINE_PRMRY_ALOWD_CHRG_AMT', api.Column.translate_type("numeric")) }}                                                 as line_prmry_alowd_chrg_amt,
    {{ dbt.safe_cast('DMERC_LINE_SCRN_SVGS_AMT', api.Column.translate_type("numeric")) }}                                                  as dmerc_line_scrn_svgs_amt,
    ...
    {{ dbt.safe_cast('DMERC_LINE_MTUS_CNT', api.Column.translate_type("string")) }}                                                          as dmerc_line_mtus_cnt,
