...
select
    ...
    {{ dbt.safe_cast('CLM_HHA_LUPA_IND_CD', api.Column.translate_type("string")) }}                                                          as clm_hha_lupa_ind_cd,
    {{ dbt.safe_cast('CLM_HHA_RFRL_CD', api.Column.translate_type("string")) }}                                                              as clm_hha_rfrl_cd,
    {{ dbt.safe_cast('PRVDR_STATE_CD', api.Column.translate_type("string")) }}                                                               as prvdr_state_cd,
    {{ dbt.safe_cast('CLM_HHA_TOT_VISIT_CNT', api.Column.translate_type("string")) }}                                                        as clm_hha_tot_visit_cnt,
    ...
    {{ dbt.safe_cast('REV_CNTR_NDC_QTY_QLFR_CD', api.Column.translate_type("numeric")) }}                                                  as rev_cntr_ndc_qty_qlfr_cd,
