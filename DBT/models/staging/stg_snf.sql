...
select
    ...
    SAFE.PARSE_DATE('%d-%b-%Y', NCH_QLFYD_STAY_FROM_DT) AS nch_qlfyd_stay_from_dt,
    SAFE.PARSE_DATE('%d-%b-%Y', NCH_QLFYD_STAY_THRU_DT) AS nch_qlfyd_stay_thru_dt,
